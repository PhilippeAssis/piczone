...
;(function ($, window, document, undefined) {
    ...
    var pluginName = 'picZone',
        defaults = {
            ...
            },	// After content is loaded into the canvas from either URL or file
            fileLoaded: function (file) {
            },	// After a file is loaded into the canvas
    ...
    Plugin.prototype = {
        ...
        camera_open: function () {
            ...
            if (!browserUserMedia) return this.set_messagebox(this.i18n.webRTCError);
            var _this = this;
            ...
            getUserMedia({
                ...
                function (err) {
                    return _this.set_messagebox(_this.i18n.webcamError);
                }
            );
        },
        ...
        _formsubmit: function () {
            if (!window.FormData) this.set_messagebox(this.i18n.formDataError);
            else {
                var _this = this;
                this.set_loading().delay(200).promise().done(function () {
                    ...
                    request.onload = function (e) {
                        if (this.status != 200) {
                            _this.set_messagebox(_this.i18n.dataSubmitError);
                        }
                        else {
                            ...
                            else _this.set_messagebox(_this.i18n.dataSubmitSuccess);
                        }
